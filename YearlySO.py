...
FIELDS = 'id,reference,customerOrderNo,salesReference,createdDate,company,firstName,lastName,projectName,source,currencyCode,currencyRate,lineItems,discountTotal,completedDate,invoiceNumber'
ROWS_PER_PAGE = 250
...
def calculate_date_range():
    ...
    start_date = datetime.datetime(2025, 1, 1, tzinfo=pytz.utc)  # January 1, 2024
    end_date = datetime.datetime(2025, 1, 10, 23, 59, 59, 999999, tzinfo=pytz.utc)  # December 31, 2024
