...
FIELDS = 'sourceUser,downloadSource,reference,company,firstName,lastName,projectName,source,currencyCode,currencyRate,lineItems,CreditNoteDate,invoiceNumber'
ROWS_PER_PAGE = 250
...
def is_valid_credit_note(credit_note, start_date, end_date):
    created_date = parse_date(credit_note.get('CreditNoteDate'))
...
def main():
    ...
    fieldnames = ['downloadSource','sourceUser','reference', 'company', 'firstName', 'lastName', 'projectName', 
                  ...
                  'lineItemQty', 'lineItemUnitPrice', 'lineItemDiscount', 'CreditNoteDate']
