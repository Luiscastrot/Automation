...
def calculate_date_range():
    ...
    start_date = datetime.datetime(2025, 2, 1, tzinfo=pytz.utc)  # (Year, Month, Day, Hour, Minute, Second, ...,)
    end_date = datetime.datetime(2025, 3, 31, 23, 59, 59, 999999, tzinfo=pytz.utc)  # (Year, Month, Day, Hour, Minute, Second, ...,)
